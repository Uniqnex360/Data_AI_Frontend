...
export default function AggregationTab({ initialFilter = "all" }: Props) {
  ...
  const [aggregatingProductId, setAggregatingProductId] = useState<
    string | null
  >(null);
                      ...
                      products.map((product) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              {getProductStatusBadge(product.enrichment_status)}
                            </td>
                              ...
                              {product.enrichment_status !== "completed" &&
                                product.enrichment_status !== "processing" && (
                                  <button
                                    ...
                                    disabled={
                                      aggregatingProductId === product.id ||
