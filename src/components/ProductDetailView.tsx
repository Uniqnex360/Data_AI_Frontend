          ...
          <table className="w-full text-left border-collapse table-fixed">
            <thead className="sticky top-0 bg-slate-50 z-20 border-b border-slate-200">
              <tr className="text-[13px] font-semibold text-slate-500">
                <th className="p-4 w-12 bg-slate-50 sticky left-0 z-30 shadow-[1px_0_0_0_#e2e8f0]">
                  <input
                    ...
                    checked={
                      ...
                      filteredProducts.every((p) => selectedRowIds.has(p.id))
                    }
                    onChange={() => {
                ...
                <th className="p-4 w-64 border-l border-slate-100 text-center">
                  Recommended Title
                </th>
              ...
              {loading ? (
                ...
                filteredProducts.map((p) => (
                  ...
                  >
                    ...
                    <td className="p-4 border-l border-slate-50 text-center text-xs text-slate-700">
  <div className="truncate max-w-[220px]" title={p.title_recommendation || ""}>
